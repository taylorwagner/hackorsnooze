...
class Story {
  ...
  getHostName() {
    // UNIMPLEMENTED: complete this function! //DONE TW
...
class StoryList {
  ...
  static async getStories() {
    ...
    //  instance method? //getStories is returning an instance of the class itself i.e. StoryList.getStories() TW
  ...
  async addStory(user, {title, author, url}) {
    ...
    const created = new Story(res.data.story);
    this.stories.unshift(created);
    user.ownStories.unshift(created);
...
class User {
   ...
   * --> newState: "add" or "delete"
   * --> story: Story instance to make favorite/not-favorite
   */

  async _addOrDeleteFavorite(newState, story) {
